...
class ReasoningGenerator:
    ...
    def _build_prompt(self, candidate_context: str, jd: str) -> str:
        prompt = (
            ...
            "Focus only on technical skills and relevant professional experience rather than assuming. "
            ...
            f"{candidate_context}\n\n"
            "Task:\n"
            "Write exactly 1-2 sentences explaining why the candidate is a good fit for the role. "
